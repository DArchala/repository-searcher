...
public class GithubRepositoriesController {
    ...
    public ResponseEntity<GithubUser> findUserRepositories(@Valid @NotBlank(message = "Username must not be blank") @RequestParam String username) throws InternalServerException, UserNotFoundException, RepositoriesNotFoundException {
