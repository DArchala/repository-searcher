...
public final class HttpUtils {
    ...
    public static HttpRequest getUserReposHttpRequest(String username) {
        return getHttpRequestByUri(String.format(USER_REPOSITORIES_URL_TEMPLATE, username));
    }

    public static HttpRequest getReposBranchesHttpRequest(String username, String repository) {
        return getHttpRequestByUri(String.format(REPOSITORY_BRANCHES_URL_TEMPLATE, username, repository));
    }

    private static HttpRequest getHttpRequestByUri(String stringUri) {
